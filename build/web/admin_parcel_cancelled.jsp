<%-- 
    Document   : admin_parcel_cancelled
    Created on : 30 Oct, 2021, 11:10:16 PM
    Author     : Dell
--%>
                ...
                <%
                    try {
                        ...
                        if (qry != null) {
                            ...
                            data = "select parcel.p_id,parcel.p_consignment_no,customer.c_name,recipient.r_name,parcel_details.p_status from parcel,customer,recipient,parcel_details where parcel.c_id=customer.c_id and parcel.r_id=recipient.r_id and parcel.p_id=parcel_details.p_id and parcel_details.p_status='Cancelled By User'";
                        }
