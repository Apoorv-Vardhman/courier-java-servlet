<%-- 
    Document   : admin_parcel_all
    Created on : 30 Oct, 2021, 3:58:36 PM
    Author     : Dell
--%>
...
<div class="page-content p-5" id="content">
    ...
    <table class="table table-bordered table-hover">
        ...
        <form action="admin_parcel_all.jsp">
            <tbody>
                <%
                    ...
                    try {
                        ...
                        if (qry != null) {
                            ...
                            data = "select parcel.p_id,parcel.p_consignment_no,customer.c_name,recipient.r_name,parcel_details.p_status from parcel,customer,recipient,parcel_details where parcel.c_id=customer.c_id and parcel.r_id=recipient.r_id and parcel.p_id=parcel_details.p_id";
                        }
                ...
                <tr>
                    ...
                    <td class="col-md-1 col-lg-1 col-xl-1 text-center">                    
                        ...
                        <a href="admin_parcel_view.jsp?pa_id=<%=res.getString("parcel.p_id")%>" class="btn btn-warning">View</a>
